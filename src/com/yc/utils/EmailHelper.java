...
//        YanZhengma = String.valueOf(radomInt);
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("1395382937@qq.com", "oqkfrtmipndlibab");
            }
        });
        //开启debug模式
        ...
        transport.connect("smtp.qq.com", "1395382937@qq.com", "oqkfrtmipndlibab");
        
        //创建邮件对象
        MimeMessage mimeMessage = new MimeMessage(session);
        //邮件发送人
        mimeMessage.setFrom(new InternetAddress("1395382937@qq.com"));
        //邮件接收人
     ...
     * @throws GeneralSecurityException
     */
    public void email(String emailNum, String YanZhengma, String name) throws MessagingException, GeneralSecurityException {
        String email = "<!DOCTYPE html>\n" +
                ...
                "                        <p><b>验证码：</b><span class=\"font_lightblue\"><span id=\"yzm\"  onclick=\"return false;\" t=\"7\" style=\"border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;\">" + YanZhengma + "</span></span><br><span class=\"font_gray\">(请输入该验证码完成密码，验证码30分钟内有效！)</span></p>\n" +
                "                        <div class=\"line\">如果你未申请修改密码服务，请忽略该邮件。</div>\n" +
                "                    </div>\n" +
                "                </div>\n" +
